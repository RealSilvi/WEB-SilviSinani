...
var require_module_cjs = __commonJS({
    '../alpine/packages/alpinejs/dist/module.cjs.js'(exports, module) {
        ...
        var __export = (target, all2) => {
            for (var name in all2) __defProp2(target, name, { get: all2[name], enumerable: true });
        };
        ...
        function handleError(error2, el, expression = void 0) {
            error2 = Object.assign(error2 != null ? error2 : { message: 'No error message given.' }, {
                el,
                expression,
            });
            console.warn(
...
var require_module_cjs3 = __commonJS({
    '../alpine/packages/focus/dist/module.cjs.js'(exports, module) {
                        ...
                        if (valueOrHandler(config.clickOutsideDeactivates, e)) {
                            trap.deactivate({
                                returnFocus:
                                    ...
                                    !tabbable.isFocusable(target, config.tabbableOptions),
                            });
                            return;
                        }
                            ...
                            if (containerIndex < 0) {
                                ...
                                if (
                                    ...
                                    (containerGroup.container === target ||
                                        (tabbable.isFocusable(target, config.tabbableOptions) &&
                                            !tabbable.isTabbable(target, config.tabbableOptions) &&
        ...
        function src_default(Alpine19) {
            ...
            Alpine19.directive(
                'trap',
                Alpine19.skipDuringClone(
                    (el, { expression, modifiers }, { effect, evaluateLater, cleanup: cleanup2 }) => {
    ...
    '../alpine/packages/intersect/dist/module.cjs.js'(exports, module) {
        ...
        function src_default(Alpine19) {
            Alpine19.directive(
                'intersect',
                Alpine19.skipDuringClone(
                    (el, { value, expression, modifiers }, { evaluateLater, cleanup: cleanup2 }) => {
    ...
    '../alpine/packages/anchor/dist/module.cjs.js'(exports, module) {
        ...
        function getClippingRect(_ref) {
            ...
            const elementClippingAncestors =
                boundary === 'clippingAncestors' ? getClippingElementAncestors(element, this._c) : [].concat(boundary);
...
function handleFileUpload(el, property, component, cleanup2) {
    ...
    let start2 = () =>
        el.dispatchEvent(
            new CustomEvent('livewire-upload-start', { bubbles: true, detail: { id: component.id, property } }),
        );
    let finish = () =>
        el.dispatchEvent(
            new CustomEvent('livewire-upload-finish', { bubbles: true, detail: { id: component.id, property } }),
        );
    let error2 = () =>
        el.dispatchEvent(
            new CustomEvent('livewire-upload-error', { bubbles: true, detail: { id: component.id, property } }),
        );
    let cancel = () =>
        el.dispatchEvent(
            new CustomEvent('livewire-upload-cancel', { bubbles: true, detail: { id: component.id, property } }),
        );
...
function removeUpload(component, name, tmpFilename, finishCallback = () => {}, errorCallback = () => {}) {
    let uploadManager = getUploadManager(component);
...
wireProperty(
    ...
    (component) =>
        (property, reactive = true) =>
            dataGet(reactive ? component.reactive : component.ephemeral, property),
);
    ...
    if (directive2.modifiers.includes('class')) {
        ...
        let display =
            ['inline', 'block', 'table', 'flex', 'grid', 'inline-flex'].filter((i) =>
                directive2.modifiers.includes(i),
            )[0] || 'inline-block';
...
function triggerComponentRequest(el, directive2) {
    import_alpinejs16.default.evaluate(
        el,
