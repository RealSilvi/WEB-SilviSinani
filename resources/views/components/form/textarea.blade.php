...
<textarea name="{{ $name }}" type="{{ $type }}"
    {{ $attributes->class([
        'w-full bg-transparent px-0 py-2 text-base font-base border-0 border-b focus:border-primary focus:ring-0 focus:outline-none focus:outline-offset-0 focus:outline-none',
