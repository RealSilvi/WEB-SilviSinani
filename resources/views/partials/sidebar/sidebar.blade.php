<aside
    class="fixed z-40 w-screen bottom-0 lg:right-0 lg:top-0 lg:h-full lg:w-20 h-15 p-2 lg:py-0">
    <div class="w-full h-full bg-white lg:flex lg:flex-col">
        ...
        <div class="f h-full w-full bg-white  lg:py-2 rounded-full">
