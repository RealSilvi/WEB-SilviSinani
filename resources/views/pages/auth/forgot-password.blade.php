...
@section('content')
    <section class="w-full mx-auto max-w-screen-2xl flex flex-1 items-center justify-center">
        <div class="p-10 lg:px-20 xl:pb-20 w-full">
            <div class="flex flex-col lg:grid lg:grid-cols-2 xl:gap-40 lg:gap-10  items-center justify-center gap-5 lg:px-10 xl:px-20">
                ...
                <div class="w-full lg:order-first flex flex-col gap-10">
                    <div class=" text-3xl xl:text-4xl font-medium">
            ...
            <div class="mt-10 lg:mt-15 xl:mt-20">
                <form action="/auth/forgot-password" method="post" class="lg:px-10 xl:px-20">
                    @csrf
