        ...
        <div class="p-10 lg:px-20 xl:pb-20 w-full">
            <div class="flex flex-col items-center justify-center gap-10">
                ...
                <div class="text-center lg:text-start lg:px-10 xl:px-20 text-3xl xl:text-4xl w-full font-medium">
                    {{ __('pages.reset_password.title') }}
                </div>
            </div>

            <div class="mt-10 lg:mt-15 xl:mt-20 flex flex-col">
                <form action="/auth/reset-password" method="post" class="lg:px-10 xl:px-20">
                    @csrf
...
@section('content')
    <div class="flex flex-1 items-center justify-center px-3 py-16">

        <div class="mx-auto w-full max-w-2xl px-4 py-8 md:px-16 md:py-12">
            <div>
                <h1 class="font-medium text-title  leading-8">
                    {{ __('pages.reset_password.title') }}
                </h1>
            </div>

            <form action="/auth/reset-password" method="post" class="mt-14">
                @csrf
                ...
                <div class="flex flex-col gap-14">
                    <x-form.group name="password">
                        ...
                        <x-form.input class="placeholder-primary placeholder:font-black"
                                      placeholder="{{ __('form.reset_password.password') }}" type="password" />
                    </x-form.group>
